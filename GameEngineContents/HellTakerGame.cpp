...
void HellTakerGame::GameImageCut()
{
	...
	{
		GameEngineImage* Image = GameEngineImageManager::GetInst()->Find("BloodEffect_1.bmp");
		Image->Cut({ 340, 340 });
	}
	...
	{
		GameEngineImage* Image = GameEngineImageManager::GetInst()->Find("BloodEffect_3.bmp");
		Image->Cut({ 340, 340 });
	}
	...
	{
		GameEngineImage* Image = GameEngineImageManager::GetInst()->Find("Thorn_InAni.bmp");
		Image->Cut({ 68,66 });
	}


	{
		GameEngineImage* Image = GameEngineImageManager::GetInst()->Find("Thorn_OutAni.bmp");
		Image->Cut({ 68,66 });
	}
	...
	{
		GameEngineImage* Image = GameEngineImageManager::GetInst()->Find("Key.bmp");
		Image->Cut({ 60,132 });
	}
